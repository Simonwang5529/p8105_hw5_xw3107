...
We estimate, by simulation, the probability that a group of size \(n\) (with birthdays i.i.d. Uniform over 365 days, no leap years) has **at least one shared birthday**.
