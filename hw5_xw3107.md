...
We estimate, by simulation, the probability that a group of size $n$
(with birthdays i.i.d. Uniform over 365 days, no leap years) has **at
...
## Problem 2 — Exploring power in a one-sample t-test
...
# helper: run one t-test and tidy output 
...
```
    ...
    ## Rows: 35,000
    ## Columns: 10
    ## $ estimate    <dbl> 1.03395167, 0.31433950, -0.78800157, -1.11821754, -1.68147…
    ## $ statistic   <dbl> 1.16014918, 0.35644247, -0.79259034, -1.23962116, -2.06818…
    ## $ p.value     <dbl> 0.25545041, 0.72408957, 0.43445299, 0.22505361, 0.04764436…
    ## $ parameter   <dbl> 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29…
    ## $ conf.low    <dbl> -0.7888041, -1.4893077, -2.8213902, -2.9631454, -3.3442901…
    ## $ conf.high   <dbl> 2.85670743, 2.11798670, 1.24538704, 0.72671036, -0.0186629…
    ...
    ## $ mu_hat      <dbl> 1.03395167, 0.31433950, -0.78800157, -1.11821754, -1.68147…
...
ggplot(power_df, aes(x = mu_true, y = power)) +
  ...
  labs(
    x = "True mean (μ)",
    y = "Power (P[reject H₀])",
    title = "Power vs. true mean in a one-sample t-test",
